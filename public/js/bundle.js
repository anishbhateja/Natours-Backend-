...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYW5pc2hiaGF0ZWphIiwiYSI6ImNraDFtN2RvazA2bnoycm83eHcyMzRzNXgifQ.gV1G0GSn9c3dOw1Oy7rzHw'; //this will put the map on the element called 'map' as stated below
...
var stripe = Stripe('pk_test_51HklVTHOQueVdWWoyoBb7GGhrdXqWNduYhaoJmseqXSXNwOcCkV0irC8Qa7oxUzz6BhuxRdwJTjXgd6XnrmWSkqa00icZPEyet');
    ...
    regeneratorRuntime.mark(function _callee(e) {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault(); //This is used for sending multipart/form-data using API
      ...
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              e.target.textContent = 'Processing....'; //e.target= CLICKED ELEMENT ITSELF
